        ...
        <div className="conocePhotosContainer">
          ...
          <div className="conocePhoto2Container" >
            <div className="video-background">
              ...
              <source src="https://res.cloudinary.com/dbohxop49/video/upload/v1724555658/videoConocebali_nuf6ik.mp4" type="video/mp4" />
        Your browser does not support the video tag.
        </video>
            </div>
            <div className="imgContainerModel">
            <Image src={"https://res.cloudinary.com/dbohxop49/image/upload/v1724556193/conocebali2_eudjdf.jpg"} alt="photo" fill className="conocePhoto2"/>
