...
export default function Equipos() {
  ...
  return (
    <div className="equiposContainerDesktop">
      <section className="equipoDetailsMobile">         
        <div className="iluminacionTxt justifyTxtEquipos">
            ...
            <a href="/iluminacion.pdf" download="Iluminacion.pdf">
              <button onClick={downloadPdf} className="btnStyle paragraph marginButton">
                DESCARGAR LISTADO
              </button>
            </a>
        </div>
      ...
      <section className="equipoDetailsMobile">
      <div className="equiposImgContainerMobile">
          <Image src={"https://res.cloudinary.com/dbohxop49/image/upload/v1725934353/equiposC_o1asal.png"} fill alt="Equipos" className="equiposImgMobile" style={{marginRight: '3rem'}} />
        </div>

        <div className="modificadoresTxtContainer justifyTxtEquipos">
